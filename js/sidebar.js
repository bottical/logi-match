(function(){
  ...
  window.renderSidebar = function(){
    ...
    const items=[
      { id:'inspection',href:'inspection.html',label:'検品実行',roles:['owner','admin','operator']},
      { id:'master-import',href:'master-import.html',label:'ピッキングマスター登録',roles:['owner','admin']},
      { id:'import-history',href:'import-history.html',label:'マスター投入履歴',roles:['owner','admin']},
      { id:'unstarted-list',href:'unstarted-list.html',label:'検品未着手一覧',roles:['owner','admin','operator']},
      { id:'completed-list',href:'completed-list.html',label:'検品完了一覧',roles:['owner','admin']},
      { id:'result-download',href:'result-download.html',label:'検品実績DL',roles:['owner','admin']}
