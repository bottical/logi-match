(function () {
  ...
  window.inspectionDomain = { WorkStatus, canStartInspection, canPauseInspection, canResetInspection, canResetCompleted, canForceUnlock, isCompleted, calculateSkuProgress, calculateQtyProgress, validateScanQty, matchScanCode, applyScanQty, shouldCompleteWork, assertAllowedTransition }; 
})();
